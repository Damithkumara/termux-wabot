...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const apiKey = 'cRmKovB8Q2TDVmDMu5S5' // contact me on whatsapp wa.me/6285892766102
			...
			const ownerNumber = [`$94756049015@s.whatsapp.net`]  // replace this with your number
